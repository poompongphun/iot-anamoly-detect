...
import SensorSimulate from "@/components/SensorSimulate.vue";
...
<template>
  <div>
    ...
    <div class="flex flex-col gap-2 justify-center relative px-4 mx-auto w-[80%]">
      <div>
